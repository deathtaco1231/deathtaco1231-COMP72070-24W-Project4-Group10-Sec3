...
Courier::Courier(int gooddeliv, int latedeliv, int ID, int Age, std::string Name, std::string Username, std::string Password) : Person(Age, ID, Name, Username, Password){
	this->GoodDeliveries = gooddeliv;
	this->LateDeliveries = latedeliv;
}  
